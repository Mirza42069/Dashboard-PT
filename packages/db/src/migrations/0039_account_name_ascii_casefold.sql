-- 0038 was applied to the first target database before SQL case folding was
-- made locale-independent. Repeat the finalized repair there; fresh databases
-- also run this safely after the preceding account-name migrations.
