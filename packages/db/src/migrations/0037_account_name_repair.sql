-- 0036 was applied to the first target database before its legacy-name repair
-- was hardened. Repeat that repair idempotently for databases which recorded
-- the earlier version; fresh databases also run this safely after 0036.
