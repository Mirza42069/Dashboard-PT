  ...
  return (
    <div
      ...
      className={cn(
        ...
        // The inner control sets ring-0 and delegates its ring to this wrapper,
        // so this is the real focus indicator for the whole group — it has to
        // match the 2px solid recipe the other primitives use.
